...
const PresentationSection = () => {
  ...
  const [text, setText] = useState("Assistir ao vídeo institucional");

  const setAsClicked = () => {
    setClicked(!Clicked);
    setText((prev) =>
      prev == "Fechar" ? "Assistir ao vídeo institucional" : "Fechar"
    );
  };
  return (
    <>
      <div className={styles.container}>
        <p>
          ...
          estabelecer como referência no transporte especializado de
          motocicletas na Grande Porto Alegre.
        </p>
        <p>
        ...
        <p>
          ...
          interior e até mesmo transporte de motos para outros estados. Mas
          também ajudamos você a chegar até a oficina quando precisar, para
          realizar perícias ou consertos de urgência na sua moto.
        </p>
        <h4>Demonstração</h4>
